...
df.to_excel(r'C:\Users\Ryan\Desktop\Football_Stats_Player_Stat_Line'+str(stamp)+'.xlsx')
df_snap_count = pd.DataFrame(snap_data, columns=snap_headers)
df_snap_count.to_excel(r'C:\Users\Ryan\Desktop\Football_Stats_Snaps'+str(stamp)+'.xlsx')
df_pbp = pd.DataFrame(pbp_master_list, columns=pbp_headers)
df_pbp.to_excel(r'C:\Users\Ryan\Desktop\Football_pbp'+str(stamp)+'.xlsx')
print('Done')